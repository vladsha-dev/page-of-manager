...
const Home = ({
  ...
  }, __jsx(_components_feedbacksTabs__WEBPACK_IMPORTED_MODULE_4__["default"], {
...
Home.getStaticProps = async () => {
  const res = await isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_6___default()("http://https://page-of-managerrrr.vercel.app/api/notes");
  const {
    data
  } = await res.json();
  return {
